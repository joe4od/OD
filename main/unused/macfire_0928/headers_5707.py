...
# 組place_order data
# 注意 pre_order 是true/false
# 平台券折扣：200000000
# 商店券折扣：20000000
# 商店券code：MGSE0303
# 金額扣除商店券折扣：2769900000
# 商店券promotion_id：837577326198784
# item_group_id：null
        ...
        "shoporders": [
            {
                ...
                "tax_payable": 0,
                "shipping_id": 1,
                "order_total_without_shipping": 2769900000,
                "shop": {
                    "shopid": """ + shopid + """,
                ...
                "items": [
                    {
                        ...
                        "itemid": """ + itemid + """,
                        "add_on_deal_id": 0,
                        "image": "tw-11134207-7r98y-lm22jfoocfize3",
                        "modelid":  """ + modelid + """,
                        "shopid": """ + shopid + """,
                        "offerid": 0,
                        "is_pre_order": false,
                        "name": "Apple iPhone 15 128GB A16 蘋果 原廠 限量贈門市保貼兌換券 神腦生活",
                        "non_shippable_err": "",
