...
# 商店券code：PATO2310A
# 金額扣除商店券折扣：616000000
# 商店券promotion_id：722664671363072
# item_group_id：212087450
def get_data_with_coupon(unit_price, merchandise_subtotal, promocode_applied, total_payable, quantity, shopid, itemid, modelid, voucher_code, promotionid, timestamps, voucher_type):
    ...
    data_from_api4 = """
	{
        ...
        "shoporders": [
            {
                "shipping_fee_discount": 15000000,
                "tax_payable": 0,
                "shipping_id": 1,
                "order_total_without_shipping": 616000000,
                "shop": {
                    "shopid": """ + shopid + """,
                    "seller_user_id": 846263,
                    "shop_tag": 1,
                    "cb_option": false,
                    "is_official_shop": true,
                    "shop_name": "Pato Pato 官方旗艦館 / 巧拼地墊 / 酵素清潔液 / 台灣製造",
                    "remark_type": 0,
                ...
                "iof_amount": 0,
                "import_tax_amount": 0,
                "order_total": 616000000,
                "ext_ad_info_mappings": [],
                "buyer_remark": "",
                "items": [
                    {
                        "model_name": "奶油&摩卡 / 21片",
                        "itemid": """ + itemid + """,
                        "add_on_deal_id": 212087450,
                        "image": "99cc813706dd8b4f51f9497d585bd1dc",
                        "modelid":  """ + modelid + """,
                        "shopid": """ + shopid + """,
                        "offerid": 0,
                        "is_pre_order": false,
                        "name": "【Pato Pato】嬰幼兒防摔專用 60x60x3cm 雙色巧拼地墊 21片組 I 6色任選 I 台灣製造",
                        "non_shippable_err": "",
                        ...
                        "addon_deal_sub_type": 1
                    },
                    {
                        "model_name": "隨機出色",
                        "itemid": 22507579015,
                        "add_on_deal_id": 212087450,
                        "image": "tw-11134207-7qula-lfqg6dkvbrpp8f",
                        "modelid": 231504501240,
                        "shopid": 845683,
                        "offerid": 0,
                        "is_pre_order": false,
                        "name": "【 Pato Pato 】 EVA 相機拼圖 / 益智玩具 / 靜音玩具",
                        "non_shippable_err": "",
                        "none_shippable_reason": "",
                        "is_streaming_price": false,
                        "quantity": 1,
        ...
        "checkout_price_data": {
            ...
            "shipping_discount_subtotal": 15000000,
            ...
            "import_tax_amount": 0,
            "price_adjustment": null,
            "shipping_subtotal_before_discount": 15000000,
            ...
            "shop_vouchers": [
                {
                    "shopid": """ + shopid + """,
                    "reward_type": 0,
                    "applied_voucher_code": "PATO2310A",
                    "invalid_message_code": 0,
                    "voucher_code": "PATO2310A",
                    "promotionid": 722664671363072,
                    "shipping_order_distributions": [
                        {
                            "coin_earned": 0,
                            "shipping_id": 1,
