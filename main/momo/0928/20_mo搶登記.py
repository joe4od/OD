...
# 請求的數據部分
body = 'doAction=reg&m_promo_no=M25050500004&dt_promo_no=D25050500004&gift_code=Gift001'
...
async def main():
    ...
    if not run_now:
        ...
        t4 = datetime.datetime(int(years), int(months), int(today), int(os.path.basename(__file__)[0:2]) - 1, 59, 59, 850000)
        print(t4)
    else:
