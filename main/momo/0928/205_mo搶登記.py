...
# 請求的數據部分
body = 'doAction=reg&m_promo_no=M24122700006&dt_promo_no=D24122700001&gift_code=Gift001'
...
async def main():
    ...
    if not run_now:
        ...
        t4 = datetime.datetime(int(years), int(months), int(today), 20, 29, 59, 850000)
        print(t4)
    else:
